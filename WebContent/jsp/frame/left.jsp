		...
		<tr>
			<td valign="top">
				<table width="151" border="0" align="center" cellpadding="0"
					...
					<!-- 一级菜单开始 -->
					<c:forEach items="${ps }" var="parentMenu">
					<tr>
						<td>
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
	                            <!-- 一级菜单显示 -->
												...
												<tr>
													<td>
														<table width="90%" border="0" align="center"
															...
															<!-- 二级菜单 开始-->
															<c:forEach items="${parentMenu.psons }" var="sonMenu">
															<tr>
																	...
																	<table width="95%" border="0" cellspacing="0"
																		...
																		<tr>
																			<td height="20" style="cursor: hand"
																				...
																				<span class="STYLE3"><a 
																					href="${pageContext.request.contextPath }${sonMenu.pSource}"
																					target="mainFrame">${sonMenu.pName }</a> </span>
																			</td>
																		</tr>
																	</table>
																</td>
