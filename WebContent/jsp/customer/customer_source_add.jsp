...
<script type="text/javascript" src="${pageContext.request.contextPath }/resource/js/CheckForm.js"></script>
	...
	<body>
		<form action="${pageContext.request.contextPath }/customer/customerSourceAdd"   name="form3" onsubmit="return checkForm('form3');" method="post"    >
			<table class=editTable cellSpacing=1 cellPadding=0 width="100%"
				...
				<tr>
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text" name="sourceName"   maxlength="20" check_str="顾客来源名称">
						&nbsp;
					</td>
				</tr>
